            ...
            <div id='signUpform' className="md:mt-8 mt-6 fixed grid place-items-center max-h-screen backdrop-blur-sm top-0 right-0 left-0 z-50 w-full inset-2 h-modal h-full justify-center items-center text-white bg-[black]/100 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-right bg-cover">
                <div className="bg-gray-100 text-black rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: "1000px" }}>
                    <div className="md:flex w-full">
                        ...
                        <div className="w-full md:w-1/2 py-10 px-5 md:px-10" id='signupform'>
                            ...
                            <div id='signupform'>
                                ...
                                <div className="flex -mx-3">
                                    <div className="w-full px-3 mb-5">
                                        <button type='submit' name='signUpForm' value='i_want_to_sing_up' onClick={success} className="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-2 font-semibold">REGISTER NOW</button>
                                        <button type='reset' onClick={close} className="mt-2 block w-full max-w-xs mx-auto bg-red-500 hover:bg-red-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-2 font-semibold">Cancle</button>
                                    </div>
                                </div>
                            </div>
                        </div>
