...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      <br />
      <br />
      <section id='contactUs' className="md:p-12 border-2 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover">
        <div className="font-[sans-serif] max-w-6xl mx-auto relative rounded my-6 p-4 ">
          <div className="grid lg:grid-cols-3 items-center">
            <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:mb-8">
              <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center  bg-white text-black shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                ...
                <h4 className="text-[#333] text-base font-extrabold mt-4">Visit office</h4>
              ...
              <div className="flex flex-col items-center justify-center rounded w-full h-44 p-4 text-center  bg-white text-black shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-blue-600" viewBox="0 0 100 100">
            ...
            <div className="lg:col-span-2 bg-[#0a4275] rounded sm:p-10 p-4 z-10">
              <h2 className="text-3xl text-white text-center font-extrabold mb-6">Contact Us</h2>
              <form>
                <div className="max-w-sm mx-auto space-y-4">
                  <input type='text' placeholder='Name' onChange={contacName} value={contactname}
                    className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none text-black" />
                  <input type='email' placeholder='Email' onChange={contactEmail} value={contactemail}
                    className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none text-black" />
                  <input type='number' accept='*/number' placeholder='Phone No.' onChange={contactPhone} value={contactphone}
                    className="w-full bg-gray-100 rounded py-3 px-6 text-sm outline-none text-black" />
                  <textarea placeholder='Message' rows="6" value={contactmessage} onChange={contactMessage}
                    className="w-full bg-gray-100 rounded px-6 text-sm pt-3 outline-none text-black"></textarea>
                  <button onClick={getContactInfo} type='button'
                    className="text-[#333] mx-auto block relative bg-gray-100 hover:bg-gray-200 font-semibold rounded text-sm px-6 py-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor' className="mr-2 inline text-black" viewBox="0 0 548.244 548.244">
