        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
              <div className="">
                ...
                <ul className="flex flex-col max-lg:items-center gap-6">
                  ...
                  <li><a href="/OurIdentity"
                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Our Identity</a>
                  </li>
                  <li><a href="/RefillStatus"
                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Refill Status</a>
                  </li>
                  <li><a href="/ContactUs"
                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Contact Us
                  </a></li>
                </ul>
              </div>
              <div className="">
                ...
                <form action="#" className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                    <div className="flex items-start black">
                      <input type='checkbox' className='w-5 h-5 cursor-pointer border border-gray-600 bg-transparent  rounded-md mr-2 hover:border-gray-400 hover:bg-gray-900 checked:bg-no-repeat checked:bg-center checked:border-gray-400 checked:bg-gray-800'/>
                      <label htmlFor="checked-checkbox" className="text-sm font-normal cursor-pointer text-gray-400">
                        I agree with <a href="/" className="text-amber-500">Privacy Policy</a> and <a
                          href="/" className="text-amber-500">Terms of Condition</a></label>
                    </div>
          ...
          <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
            <span className="text-sm font-normal text-gray-400">
              <a href="https://pagedone.io/" className="">©USRECHARGEREFILL.COM</a> {year}, All rights reserved.
            </span>
            <a href='tel:9692926869' className="relative  text-gray-500 focus-within:text-gray-900 ">
